...
export const cSimFail = new Counter({ name: 'arb_sim_fail_total', help: 'simulation failures', registers: [reg] });
export const cExecFail = new Counter({ name: 'arb_exec_fail_total', help: 'send failures', registers: [reg] });
