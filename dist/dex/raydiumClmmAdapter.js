...
export function makeRayClmmEdge(poolId, mintA, mintB) {
    ...
    return {
        ...
        async quoteOut(amountIn) {
            ...
            if (amountIn <= 0n)
                throw new Error('raydium: non-positive amountIn');
            return amountIn;
        },
        async buildSwapIx(_amountIn, _minOut, _user) {
